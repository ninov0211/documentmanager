...
@FacesConverter(value = "zuserConverter")
public class ZuserConverter implements Converter {

    @Inject
    private ZuserFacade ejbFacade;
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Zuser) {
            ...
            return getStringKey(o.getZuserId());
        } else {
